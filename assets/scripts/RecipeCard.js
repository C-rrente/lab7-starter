...
class RecipeCard extends HTMLElement {
	...
	set data(data) {
    	...
    	<div class="rating">
        	<span>${Math.round(data.rating * 2) / 2}</span>
        	<img src="assets/images/icons/${getStarRatingIcon(data.rating)}" alt="Rating: ${Math.round(data.rating * 2) / 2}">
...
function getStarRatingIcon(rating) {
